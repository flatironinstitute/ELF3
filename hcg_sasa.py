...
axs[0].text(s='0Q',x=12,y=2,fontsize=20)
axs[1].text(s='7Q',x=12,y=2,fontsize=20)
axs[2].text(s='13Q',x=12,y=2,fontsize=20)
axs[3].text(s='19Q',x=12,y=2,fontsize=20)
...
axs[0].axvspan(129,133,color='deepskyblue',alpha=0.3, lw=0)
axs[1].axvspan(136,140,color='deepskyblue',alpha=0.3, lw=0)
axs[2].axvspan(142,146,color='deepskyblue',alpha=0.3, lw=0)
axs[3].axvspan(148,152,color='deepskyblue',alpha=0.3, lw=0)

axs[0].axvspan(142,146,color='deepskyblue',alpha=0.3, lw=0)
axs[1].axvspan(149,153,color='deepskyblue',alpha=0.3, lw=0)
axs[2].axvspan(155,159,color='deepskyblue',alpha=0.3, lw=0)
axs[3].axvspan(161,167,color='deepskyblue',alpha=0.3, lw=0)
